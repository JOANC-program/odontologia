...
<body>
    <div id="contenedor">
        ...
        <ul id="menu">
            <li><a href="index.php?accion=vistamedico">Inicio</a></li>
            <li class="activa"><a href="index.php?accion=consultar_paciente">Citas Asignadas</a></li>
                ...
                <table border="1">
                    ...
                    <?php while ($cita = $result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars($cita['CitPaciente']); ?></td>
                            ...
                            <td>
                                <a href="index.php?accion=verCita&numero=<?php echo $cita['CitNumero']; ?>">Ver</a>
                            </td>
                        </tr>
                    <?php endwhile; ?>
                </table>
