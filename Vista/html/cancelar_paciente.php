...
<body>
    <div id="contenedor">
        ...
        <ul id="menu">
            ...
            <li class="activa"><a href="index.php?accion=cancelar_paciente">Cancelar Cita</a>
                ...
                <table border="1">
                    ...
                    <?php while ($cita = $result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td>
                                <a href="index.php?accion=cancelarCitaPaciente&numero=<?php echo $cita['CitNumero']; ?>" onclick="return confirm('¿Seguro que deseas cancelar esta cita?')">cancelar</a>
                            </td>
                        </tr>
                    <?php endwhile; ?>
                </table>
